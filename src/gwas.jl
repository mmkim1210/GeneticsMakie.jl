gwas = Dict(
    ...
    "t1d" => (url = "http://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/GCST005001-GCST006000/GCST005536/harmonised/25751624-GCST005536-EFO_0001359-Build37.f.tsv.gz",
        pmid = "25751624",
        title = "Type I diabetes (Onengut-Gumuscu et al. 2015)",
        file = "25751624-GCST005536-EFO_0001359-Build37.f.tsv.gz"),
    ...
    "dbp" => (url = "http://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/GCST90000001-GCST90001000/GCST90000059/GCST90000059_buildGRCh37.tsv", 
        pmid = "33230300",
        title = "DBP (Surendran et al. 2020)",
        file = "GCST90000059_buildGRCh37.tsv"),
    "sbp" => (url = "http://ftp.ebi.ac.uk/pub/databases/gwas/summary_statistics/GCST90000001-GCST90001000/GCST90000062/GCST90000062_buildGRCh37.tsv",
        pmid = "33230300",
        title = "SBP (Surendran et al. 2020)",
        file = "GCST90000062_buildGRCh37.tsv"),
    # Kidney
